"""
Main Live Regime V2 - Updated to use the new refactored TradeExecutor architecture.

Key changes:
- Uses the new ExecutorBuilder for clean dependency injection
- Uses TradeExecutorV3 with improved context handling
- Better error handling and state visibility
- Enhanced logging with trading context information
"""
...
class LiveTradingManager:
    ...
    def _initialize_components(self):
        ...
        self.trade_executor: TradeExecutorV3 = ExecutorBuilder.build_from_config(
            config=self.config,
            client=self.client,
