...
from app.strategy_builder.core.domain.models import ExitRules, TimeBasedExit
...
class TestTimeBasedExit(unittest.TestCase):
    ...
    def test_combined_conditions_and_time_based(self):
        ...
        from app.strategy_builder.core.domain.enums import ConditionOperatorEnum, TimeFrameEnum
